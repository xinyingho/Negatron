...
public class SDL_ClipboardEvent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(Gamepad.C_INT.withName("type"),
        ...
        Gamepad.C_BOOL.withName("owner"),
        MemoryLayout.paddingLayout(3),
        Gamepad.C_INT.withName("n_mime_types"),
        Gamepad.C_POINTER.withName("mime_types")
    ...
    private static final OfInt n_mime_types$LAYOUT = (OfInt)$LAYOUT.select(groupElement("n_mime_types"));
     ...
     * }
     */
    public static final OfInt n_mime_types$layout() {
        return n_mime_types$LAYOUT;
    }

    private static final long n_mime_types$OFFSET = 20;
     ...
     * }
     */
    public static final long n_mime_types$offset() {
        return n_mime_types$OFFSET;
    }
     ...
     * }
     */
    public static int n_mime_types(MemorySegment struct) {
        return struct.get(n_mime_types$LAYOUT, n_mime_types$OFFSET);
    }
     ...
     * }
     */
    public static void n_mime_types(MemorySegment struct, int fieldValue) {
        struct.set(n_mime_types$LAYOUT, n_mime_types$OFFSET, fieldValue);
    }
