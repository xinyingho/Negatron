...
public class SDL_GamepadButtonEvent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(Gamepad.C_INT.withName("type"), /**< SDL_EVENT_GAMEPAD_BUTTON_DOWN or SDL_EVENT_GAMEPAD_BUTTON_UP */Gamepad.C_INT.withName("reserved"),
        Gamepad.C_LONG_LONG.withName("timestamp"), /**< In nanoseconds, populated using SDL_GetTicksNS() */Gamepad.C_INT.withName("which"), /**< The joystick instance id */Gamepad.C_CHAR.withName("button"), /**< The gamepad button (SDL_GamepadButton) */Gamepad.C_BOOL.withName("down"), /**< true if the button is pressed */Gamepad.C_CHAR.withName("padding1"),
