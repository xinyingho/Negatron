...
public class SDL_KeyboardEvent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(Gamepad.C_INT.withName("type"),
        ...
        Gamepad.C_INT.withName("scancode"),
        Gamepad.C_INT.withName("key"),
        Gamepad.C_SHORT.withName("mod"),
        Gamepad.C_SHORT.withName("raw"),
        Gamepad.C_BOOL.withName("down"),
        Gamepad.C_BOOL.withName("repeat"),
