...
public class SDL_JoyBatteryEvent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(Gamepad.C_INT.withName("type"),
        ...
        Gamepad.C_LONG_LONG.withName("timestamp"), /**< In nanoseconds, populated using SDL_GetTicksNS() */Gamepad.C_INT.withName("which"), /**< The joystick instance id */Gamepad.C_INT.withName("state"), /**< The joystick battery state */Gamepad.C_INT.withName("percent"), /**< The joystick battery percent charge remaining */
