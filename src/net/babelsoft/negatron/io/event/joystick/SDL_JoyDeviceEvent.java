...
public class SDL_JoyDeviceEvent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Gamepad.C_INT.withName("type"), /**< SDL_EVENT_GAMEPAD_ADDED, SDL_EVENT_GAMEPAD_REMOVED, or SDL_EVENT_GAMEPAD_REMAPPED, SDL_EVENT_GAMEPAD_UPDATE_COMPLETE or SDL_EVENT_GAMEPAD_STEAM_HANDLE_UPDATED */
        Gamepad.C_INT.withName("reserved"),
        Gamepad.C_LONG_LONG.withName("timestamp"), /**< In nanoseconds, populated using SDL_GetTicksNS() */
        Gamepad.C_INT.withName("which"), /**< The joystick instance id */
