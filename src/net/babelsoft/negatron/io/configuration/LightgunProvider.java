...
public enum LightgunProvider implements OSD {
    ...
    LightgunProvider(String name, boolean windowsCompatible, boolean macCompatible, boolean linuxCompatible) {
        this.name = name;
    ...
    public String toString() {
        return Language.Manager.getString("lightgunprovider." + name);
    }
}
