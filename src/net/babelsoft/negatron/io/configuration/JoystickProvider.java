 ...
 * @author capan
 */
public enum JoystickProvider implements OSD {
    AUTO("auto", true, true, true),
    WINHYBRID("winhybrid", true, false, false),
    DINPUT("dinput", true, false, false),
    XINPUT("xinput", true, false, false),
    ...
    JoystickProvider(String name, boolean windowsCompatible, boolean macCompatible, boolean linuxCompatible) {
        this.name = name;
    ...
    public String toString() {
        return Language.Manager.getString("joystickprovider." + name);
    }
}
