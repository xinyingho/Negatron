 ...
 * @author capan
 */
public enum KeyboardProvider implements OSD {
    ...
    KeyboardProvider(String name, boolean windowsCompatible, boolean macCompatible, boolean linuxCompatible) {
        this.name = name;
    ...
    public String toString() {
        return Language.Manager.getString("keyboardprovider." + name);
    }
}
