 ...
 * @author capan
 */
public enum MonitorProvider implements OSD {
    AUTO("auto", true, true, true),
    DXGI("dxgi", true, false, false),
    ...
    MonitorProvider(String name, boolean windowsCompatible, boolean macCompatible, boolean linuxCompatible) {
        this.name = name;
    ...
    public String toString() {
        return Language.Manager.getString("monitorprovider." + name);
    }
}
